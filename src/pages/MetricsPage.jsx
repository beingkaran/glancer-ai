...
// A clickable KPI card: tap to reveal the source it's derived from.
function StatCard({ s, value, open, onToggle }) {
  return (
    <button type="button" className={`metric-stat${open ? ' open' : ''}`} onClick={onToggle} aria-expanded={open}>
